...
namespace Nop.Core.Plugins
{
    ...
    public partial class OfficialFeedManager : IOfficialFeedManager
    {
        ...
        /// </summary>
        /// <returns>Result</returns>
        public IList<OfficialFeedVersion> GetVersions()
        {
        ...
        public IPagedList<OfficialFeedPlugin> GetAllPlugins(int categoryId = 0,
            ...
            int pageIndex = 0, int pageSize = int.MaxValue)
        {
            ...
            //pageSize parameter is curretly ignored by official site (set to 15)
