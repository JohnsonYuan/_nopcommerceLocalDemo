...
namespace Nop.Core.Plugins
{
    ...
    {
        public static IList<string> ParseInstalledPluginFile(string filePath)
        {
        ...
        public static void SaveInstalledPluginsFile(IList<string> pluginSystems, string filePath)
        {
            string result = "";
            foreach (var sn in pluginSystems)
