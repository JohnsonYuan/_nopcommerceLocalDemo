...
namespace Nop.Core.Plugins
{
    ...
    public class PluginFinder : IPluginFinder
    {
        ...
        protected virtual bool CheckLoadMode(PluginDescriptor pluginDescriptor, LoadPluginsMode loadMode)
        {
            ...
            switch (loadMode)
            {
                ...
                case LoadPluginsMode.NotInstalledOnly:
                    return !pluginDescriptor.Installed;
                default:
                    throw new Exception("Not supported LoadPluginMode");
            }
        }
        ...
        {
            return GetPluginDescriptors(LoadPluginsMode.All).Select(x => x.Group).OrderBy(x => x);
        }
        ...
        /// <param name="loadMode">Load plugins mode</param>
        /// <param name="storeId">Load recoreds allowed only in a specified store; pass 0 to load all records</param>
