...
namespace Nop.Services.Seo
{
    public static class SeoExtensions
    {
        ...
        /// <summary>
        /// 我的注释ProductTag实现ILocalizedEntity, 需要通过languageId -＞GetLocalized
        /// 没有实现ILocalizedEntity( 如ForumGroup)则不需要GetLocalized
        /// Gets product tag SE (search engine) name
        /// </summary>
        /// <param name="productTag">Product tag</param>
            ...
            where T : BaseEntity, ISlugSupported
        {
            ...
            string entityName = typeof(T).Name; //我的注释 get class name (without namespace)
        ...
        /// <summary>
        /// 我的注释：Encoding.Unicode 采用utf-16, 是little-endian, most signifient last
