...
namespace Nop.Web.Infrastructure.Installation
{
    ...
    /// 提建议：
    /// GetAvailableLanguages（） //is default 注释写错 应该是isRightToLeft
    /// TODO:  _availableLanguages = _availableLanguages.OrderBy(l => l.Name).ToList(); 移到循环外更高效
    /// </summary>
    public partial class InstallationLocalizationService : IInstallationLocalizationService
    {
        ...
        /// </summary>
        /// <param name="resouceName">Resouce name</param>
