...
namespace Nop.Web.Framework.Localization
{
    public static class LocalizedUrlExtenstions
    {
        ...
        /// <remarks>
        /// 我的注释
        /// 调用前先判断IsLocalizedUrl, 否则得到的不是seocode
        /// </remarks>
        ...
        /// <param name="url">URL</param>
        /// <param name="applicationPath">Application path</param>
        /// <param name="isRawPath">A value indicating whether rar URL is passed</param>
        /// <returns>Result</returns>
        /// <remarks>
        /// 我的注释
        /// url的值由Request.AppRelativeCurrentExecutionFilePath传进来， isRawPath=false
        ...
        /// <remarks>
        /// 我的注释
        /// 如果 /webform1.aspx => /en/webform1.aspx
        /// /appname/webform1.aspx => /appname/en/webform1.aspx
        /// </remarks>
