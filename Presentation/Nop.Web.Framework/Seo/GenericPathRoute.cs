...
namespace Nop.Web.Framework.Seo
{
    public partial class GenericPathRoute : LocalizedRoute
    {
        ...
        /// <summary>
        /// Initializes a new instance of the System.Web.Routing.Route class, by using the specified URL pattern, default parameter values, constraints, and handler class.
        /// </summary>
        /// <param name="url">The URL pattern for the route.</param>
        /// <param name="defaults">The values to use if the URL does not contain all the parameters.</param>
        ...
        public override RouteData GetRouteData(HttpContextBase httpContext)
        {
            ...
            if (data != null && DataSettingsHelper.DatabaseIsInstalled())
            {
                ...
                if (!urlRecord.IsActive)
                {
                    ...
                    var activeSlug = urlRecordService.GetActiveSlug(urlRecord.Id, urlRecord.EntityName, urlRecord.LanguageId);
